...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-help"_s),
#endif
            tr("General"), parent);
...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-trackers"_s),
#endif
            tr("Trackers"), parent);
...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-peers"_s),
#endif
            tr("Peers"), parent);
...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-resources"_s),
#endif
...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-folder"_s),
#endif
            tr("Content"), parent);
...
#ifndef Q_OS_MACOS
            UIThemeManager::instance()->getIcon(u"btn-statistics"_s),
#endif
            tr("Speed"), parent);
